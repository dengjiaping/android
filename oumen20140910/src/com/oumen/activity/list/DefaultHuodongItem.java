...
public class DefaultHuodongItem extends RelativeLayout {
//	private RoundRectangleImageView photo;
	...
	public DefaultHuodongItem(Context context) {
		this(context, null, 0);
	}

	public DefaultHuodongItem(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public DefaultHuodongItem(Context context, AttributeSet attrs, int defStyle) {
