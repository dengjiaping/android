...
public class ActivityBean implements Parcelable, ShareData, HuodongDetailHeaderProvider {
	...
	public String toString() {
		return "ActivityBean [atId=" + atId + ", huodongId=" + huodongId + ", name=" + name + ", address=" + address + ", uid=" + uid + ", description=" + description + ", pic=" + pic + ", lat=" + lat + ", lng=" + lng + ", cityCode=" + cityCode + ", applyEndTime=" + applyEndTime + ", startTime="
				+ startTime + ", endTime=" + endTime + ", applyAge=" + applyAge + ", limitNum=" + limitNum + ", applyNum=" + applyNum + ", askPhone=" + askPhone + ", money=" + money + ", updateTime=" + updateTime + ", top=" + top + ", push=" + push + ", pushTime=" + pushTime + ", verified="
				+ verified + ", modTime=" + modTime + ", addTime=" + addTime + ", userType=" + userType + ", hot=" + hot + ", today=" + today + ", over=" + over + ", weekend=" + weekend + ", topTime=" + topTime + ", distance=" + distance + ", applyers=" + applyers + ", pics=" + pics
				+ ", senderUid=" + senderUid + ", senderName=" + senderName + ", senderPic=" + senderPic + ", senderSex=" + senderSex + ", ShareUrl=" + ShareUrl + ", teamId=" + teamId + ", isApply=" + isApply + ", lookNum=" + lookNum + ", openNotice=" + openNotice + ", haoPing=" + haoPing
				+ ", chaPing=" + chaPing + ", startPingfen=" + startPingfen + "]";
	}
