package com.oumen.widget.refushlist;
...
public class AbPullListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		mHeaderView.setHeaderProgressBarDrawable(this.getResources().getDrawable(R.drawable.progress_circular));
		mFooterView.setFooterProgressBarDrawable(this.getResources().getDrawable(R.drawable.progress_circular));
	}
