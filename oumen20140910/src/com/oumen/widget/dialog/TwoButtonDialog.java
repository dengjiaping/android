...
public class TwoButtonDialog extends Dialog {
	...
	public TwoButtonDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
	...
	private void preInitialize(Context context, boolean cancelable) {
		...
		layContainer = (LinearLayout) inflater.inflate(R.layout.dialog_two_button, null);
		...
		btnLeft = (Button) layContainer.findViewById(R.id.btn_left);

		btnRight = (Button) layContainer.findViewById(R.id.btn_right);
