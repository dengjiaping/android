...
public class SimpleCircle implements Parcelable {
	...
	private SimpleCircle() {}

	public SimpleCircle(JSONObject obj) throws JSONException {
...
//	}
	...
	public static List<SimpleCircle> query(int selfUid, DatabaseHelper helper) {
		LinkedList<SimpleCircle> results = new LinkedList<SimpleCircle>();
		synchronized (helper) {
			SQLiteDatabase db = helper.getReadableDatabase();
	...
	public static SimpleCircle query(int selfUid, int id, DatabaseHelper helper) {
		SimpleCircle result = null;
		synchronized (helper) {
			SQLiteDatabase db = helper.getReadableDatabase();
	...
	public static void update(int selfUid, SimpleCircle bean, DatabaseHelper helper) {
...
//				ELog.i("Insert:" + selfUid + "/" + bean.id);
	...
	public static SimpleCircle cursor2bean(Cursor cursor) {
		SimpleCircle bean = new SimpleCircle();
	...
	public static final Parcelable.Creator<SimpleCircle> CREATOR = new Parcelable.Creator<SimpleCircle>() {
		public SimpleCircle createFromParcel(Parcel in) {
			SimpleCircle bean = new SimpleCircle();
			bean.id = in.readInt();
			try {
		...
		public SimpleCircle[] newArray(int size) {
			return new SimpleCircle[size];
		}
	};
