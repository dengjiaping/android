...
import com.oumen.circle.list.CircleController1.CircleListAdapter;
 ...
 * 偶们圈所有联网请求
 */
public class CircleHttpController1 {
	...
	public CircleHttpController1(Handler handler) {
	...
	public HttpRequest obtainList(final ObtainType obtainType, CircleListAdapter adapter) {
		...
		if (obtainType == null) {
			...
			List<SimpleCircle1> cache = SimpleCircle1.query(selfUid, App.DB);
			for (SimpleCircle1 i : cache) {
				try {
